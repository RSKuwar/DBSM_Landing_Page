(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=class{constructor(){this.appContainer=document.getElementById(`app`),this.currentView=`home`,this.totalFrames=120,this.frames=[],this.loadedFramesCount=0,this.currentFrameIndex=0,this.targetFrameIndex=0,this.initHTML(),this.initFrameEngine(),this.setupNavigation()}initHTML(){this.appContainer.innerHTML=`
      ...
      <section class="section-wrapper" id="courses-preview">
        ...
        <div class="courses-grid">
          ...
          <div class="course-card scroll-reveal reveal-right stagger-2">
            <div class="img-reveal-wrapper">
              <img src="/DBSM_Landing_Page/aws_course.png" style="width:100%; height:180px; object-fit:cover; margin-bottom:1.5rem;" alt="AWS" />
            </div>
          ...
          <div class="course-card scroll-reveal reveal-left stagger-3">
            <div class="img-reveal-wrapper">
              <img src="/DBSM_Landing_Page/dcom_course.jpg" style="width:100%; height:180px; object-fit:cover; margin-bottom:1.5rem;" alt="DCOM" />
            </div>
    ...
    `}initFrameEngine(){this.frames=Array(this.totalFrames),this.frameStatus=Array(this.totalFrames).fill(0),this.baseUrl=`/DBSM_Landing_Page/`,this.lastScrollY=window.scrollY,this.scrollDirection=`down`,this.maxMemoryCacheWindow=35,this.loadFrame(1,`high`),this.renderCanvasFrame(0);for(let e=2;e<=10;e++)this.loadFrame(e,`high`);this.updateScrollDirection(),this.initCanvasScrollLoop(),this.initLazyImageObserver()}loadFrame(e,t=`auto`){if(e<1||e>this.totalFrames)return;let n=e-1;if(this.frameStatus[n]!==0)return;this.frameStatus[n]=1;let r=new Image;`fetchPriority`in r&&(r.fetchPriority=t);let i=String(e).padStart(3,`0`);r.src=`${this.baseUrl}frames/dbsm-${i}.webp`,r.onload=()=>{this.frameStatus[n]=2,r.decode&&r.decode().catch(()=>{}),e===1&&this.currentView===`home`&&this.renderCanvasFrame(0)},r.onerror=()=>{this.frameStatus[n]=0},this.frames[n]=r}updateScrollDirection(){let e=window.scrollY;e>this.lastScrollY+2?this.scrollDirection=`down`:e<this.lastScrollY-2&&(this.scrollDirection=`up`),this.lastScrollY=e}scheduleDirectionalPreload(e){let t=Math.round(e)+1;if(this.scrollDirection===`down`){for(let e=t;e<=Math.min(this.totalFrames,t+18);e++)this.loadFrame(e,e<=t+5?`high`:`auto`);for(let e=t-1;e>=Math.max(1,t-6);e--)this.loadFrame(e,`low`)}else{for(let e=t;e>=Math.max(1,t-18);e--)this.loadFrame(e,e>=t-5?`high`:`auto`);for(let e=t+1;e<=Math.min(this.totalFrames,t+6);e++)this.loadFrame(e,`low`)}let n=Math.max(1,t-this.maxMemoryCacheWindow),r=Math.min(this.totalFrames,t+this.maxMemoryCacheWindow);for(let e=0;e<this.totalFrames;e++){let t=e+1;(t<n||t>r)&&this.frames[e]&&this.frameStatus[e]===2&&(this.frames[e].src=``,this.frames[e]=null,this.frameStatus[e]=0)}}initLazyImageObserver(){if(!(`IntersectionObserver`in window))return;let e=new IntersectionObserver((e,t)=>{e.forEach(e=>{if(e.isIntersecting){let n=e.target;n.dataset.src&&(n.src=n.dataset.src,n.decode&&n.decode().catch(()=>{}),delete n.dataset.src),t.unobserve(n)}})},{rootMargin:`300px 0px`});document.querySelectorAll(`img[data-src]`).forEach(t=>{e.observe(t)})}renderCanvasFrame(e){if(!this.canvas){if(this.canvas=document.getElementById(`hero-frame-canvas`),!this.canvas)return;this.ctx=this.canvas.getContext(`2d`,{alpha:!1})}if(!this.ctx)return;let t=window.innerWidth,n=window.innerHeight,r=Math.min(window.devicePixelRatio||1,1.5),i=Math.floor(t*r),a=Math.floor(n*r);(this.canvas.width!==i||this.canvas.height!==a)&&(this.canvas.width=i,this.canvas.height=a);let o=this.frames[e];if(!o||!o.complete||o.naturalWidth===0)for(let t=1;t<this.totalFrames;t++){let n=this.frames[Math.max(0,e-t)];if(n&&n.complete&&n.naturalWidth>0){o=n;break}let r=this.frames[Math.min(this.totalFrames-1,e+t)];if(r&&r.complete&&r.naturalWidth>0){o=r;break}}if(o&&o.complete&&o.naturalWidth>0){let e=o.naturalWidth/o.naturalHeight,t=i/a,n,r,s,c;t>e?(n=i,r=i/e,s=0,c=(a-r)/2):(r=a,n=a*e,s=(i-n)/2,c=0),this.ctx.drawImage(o,s,c,n,r)}}initCanvasScrollLoop(){let e=document.getElementById(`navbar`),t=()=>{if(this.currentView===`home`){this.updateScrollDirection();let e=document.getElementById(`hero-scroll-container`);if(e){let t=e.getBoundingClientRect(),n=e.offsetHeight-window.innerHeight,r=-t.top,i=Math.min(Math.max(r/(n||1),0),1);this.targetFrameIndex=Math.min(Math.floor(i*(this.totalFrames-1)),this.totalFrames-1),this.currentFrameIndex+=(this.targetFrameIndex-this.currentFrameIndex)*.25;let a=Math.round(this.currentFrameIndex);this.scheduleDirectionalPreload(a),this.renderCanvasFrame(a);let o=document.getElementById(`hero-text`);if(o){let e=Math.max(1-i*2.2,0),t=-i*100;o.style.opacity=e,o.style.transform=`translateY(${t}px)`}}}if(this.currentView===`faculty`&&window.innerWidth>768){let e=document.getElementById(`faculty-scroll-container`),t=document.getElementById(`faculty-track`),n=document.getElementById(`faculty-scroll-progress-bar`),r=document.getElementById(`faculty-header-wrapper`);if(e&&t){let i=e.getBoundingClientRect(),a=e.offsetHeight-window.innerHeight,o=-i.top,s=Math.min(Math.max(o/(a||1),0),1),c=t.scrollWidth,l=window.innerWidth,u=Math.max(c-l*.45,0),d=-s*u;if(t.style.transform=`translateX(${d}px)`,n&&(n.style.width=`${s*100}%`),r){let e=Math.max(1-s*1.5,.7);r.style.opacity=e}let f=Array.from(t.querySelectorAll(`.faculty-card-horiz`)),p=l*.25;f.forEach(e=>{let t=e.getBoundingClientRect(),n=t.left+t.width/2;Math.abs(n-p)<240?e.classList.add(`is-focused`):e.classList.remove(`is-focused`)})}}this.handleScrollReveals(),e&&(window.scrollY>50?e.classList.add(`scrolled`):e.classList.remove(`scrolled`)),requestAnimationFrame(t)};requestAnimationFrame(t)}handleScrollReveals(){let e=document.querySelectorAll(`.scroll-reveal`),t=window.innerHeight;e.forEach(e=>{let n=e.getBoundingClientRect();n.top<t*.88&&n.bottom>40?e.classList.add(`is-visible`):e.classList.remove(`is-visible`)}),document.querySelectorAll(`.stat-number`).forEach(e=>{let n=e.getBoundingClientRect(),r=n.top<t&&n.bottom>0;if(r&&!e.classList.contains(`has-animated`)){e.classList.add(`has-animated`);let t=parseInt(e.getAttribute(`data-target`)||`0`,10),n=e.getAttribute(`data-suffix`)||``,r=0,i=Math.ceil(t/40),a=setInterval(()=>{r+=i,r>=t&&(r=t,clearInterval(a)),e.innerHTML=`${r.toLocaleString()}${n}`},25)}else!r&&e.classList.contains(`has-animated`)&&(e.classList.remove(`has-animated`),e.innerHTML=`0${e.getAttribute(`data-suffix`)||``}`)})}openCourseModal(e){let t={ev:{title:`EV — Electric Vehicle Engineering`,code:`EV DOMAIN CERTIFICATION`,desc:`Master lithium-ion battery chemistry, motor controllers, powertrain assembly, charging station infrastructure, and OBD diagnostic tools.`,duration:`3 Months Intensive Practical Training`,career:`EV Service Engineer, Battery Assembly Lead, Charging Network Technician`},aws:{title:`AWS re/Start — Cloud Computing`,code:`AWS CLOUD CERTIFICATION`,desc:`Comprehensive Linux command-line, Python scripting, AWS Core Services (EC2, S3, VPC, IAM, RDS), network security, and cloud deployment.`,duration:`12 Weeks Full-time Classroom Training`,career:`Cloud Operations Associate, Junior DevOps Engineer, AWS Support Specialist`},dcom:{title:`DCOM — Data Centre Operations`,code:`DATA CENTRE INFRASTRUCTURE`,desc:`Enterprise server rack layout, fiber/copper structured cabling, UPS power redundancy, precision HVAC cooling, and DCIM monitoring.`,duration:`3 Months Practical Facility Training`,career:`Data Centre Operations Engineer, Rack Management Specialist, Facilities Support`},gsa:{title:`GSA — Guest Service Associate`,code:`LUXURY HOSPITALITY & SERVICES`,desc:`Front desk operations, Property Management Systems, luxury hospitality standards, cross-cultural communication, and guest relations.`,duration:`3 Months Practical Service Training`,career:`Guest Relations Associate, Front Desk Executive, Hospitality Manager`}},n=t[e]||t.ev,r=document.getElementById(`modal-content`),i=document.getElementById(`course-modal-backdrop`);r&&i&&(r.innerHTML=`
      ...
      `,i.classList.add(`active`))}closeCourseModal(){let e=document.getElementById(`course-modal-backdrop`);e&&e.classList.remove(`active`)}setupNavigation(){document.addEventListener(`click`,e=>{let t=e.target.closest(`[data-view]`),n=e.target.closest(`[data-modal]`),r=e.target.closest(`#modal-close-btn`),i=e.target.classList.contains(`modal-backdrop`);if(t){e.preventDefault();let n=t.getAttribute(`data-view`);this.switchView(n)}else if(n){e.preventDefault();let t=n.getAttribute(`data-modal`);this.openCourseModal(t)}else(r||i)&&this.closeCourseModal()})}switchView(e){this.currentView=e;let t=document.getElementById(`main-content`);switch(window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0,this.canvas=null,this.ctx=null,this.currentFrameIndex=0,this.targetFrameIndex=0,document.querySelectorAll(`.nav-link`).forEach(t=>{t.classList.toggle(`active`,t.getAttribute(`data-view`)===e)}),e){case`home`:t.innerHTML=this.renderHomeView(),this.loadFrame(1,`high`),requestAnimationFrame(()=>{this.renderCanvasFrame(0)});break;case`about`:t.innerHTML=this.renderAboutView();break;case`campus-tour`:t.innerHTML=this.renderCampusTourView();break;case`courses`:t.innerHTML=this.renderCoursesView();break;case`ev-course`:t.innerHTML=this.renderEvCourseView();break;case`gsa-course`:t.innerHTML=this.renderGsaCourseView();break;case`aws-course`:t.innerHTML=this.renderAwsCourseView();break;case`dcom-course`:t.innerHTML=this.renderDcomCourseView();break;case`student-life`:t.innerHTML=this.renderStudentLifeView();break;case`faculty`:t.innerHTML=this.renderFacultyView();break;default:t.innerHTML=this.renderHomeView(),this.loadFrame(1,`high`),requestAnimationFrame(()=>{this.renderCanvasFrame(0)})}}};window.addEventListener(`DOMContentLoaded`,()=>{new e});