(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=class{constructor(){this.appContainer=document.getElementById(`app`),this.currentView=`home`,this.totalFrames=120,this.frames=[],this.loadedFramesCount=0,this.currentFrameIndex=0,this.targetFrameIndex=0,this.initHTML(),this.preloadWebPFrames(),this.setupNavigation()}initHTML(){this.appContainer.innerHTML=`
    ...
    `}renderEvCourseView(){return`<section class="section-wrapper" style="padding-top: 12rem;"><span class="section-label">EV — ELECTRIC VEHICLE</span><h1 class="section-title">Build the Future of Mobility.</h1><p style="color:var(--text-muted); font-size:1.1rem; line-height:1.8; max-width:700px;">Master EV powertrains, battery management systems, motor controllers and automotive electrical diagnostics.</p><button class="nav-btn-champagne" style="margin-top:2rem;" onclick="alert('Application submitted for EV Course!')">Apply / Enquire Now</button></section>`}renderGsaCourseView(){return`<section class="section-wrapper" style="padding-top: 12rem;"><span class="section-label">GSA — GUEST SERVICE ASSOCIATE</span><h1 class="section-title">Create Experiences That Matter.</h1><p style="color:var(--text-muted); font-size:1.1rem; line-height:1.8; max-width:700px;">Premium customer experience, luxury hospitality standards, international communication and service management.</p><button class="nav-btn-champagne" style="margin-top:2rem;" onclick="alert('Application submitted for GSA Course!')">Apply / Enquire Now</button></section>`}renderAwsCourseView(){return`<section class="section-wrapper" style="padding-top: 12rem;"><span class="section-label">AWS RE/START — CLOUD COMPUTING</span><h1 class="section-title">Build Your Career in the Cloud.</h1><p style="color:var(--text-muted); font-size:1.1rem; line-height:1.8; max-width:700px;">Comprehensive cloud architecture training covering Linux, Python, AWS services, security and DevOps foundation.</p><button class="nav-btn-champagne" style="margin-top:2rem;" onclick="alert('Application submitted for AWS re/Start!')">Apply / Enquire Now</button></section>`}renderDcomCourseView(){return`<section class="section-wrapper" style="padding-top: 12rem;"><span class="section-label">DCOM — DATA CENTRE OPERATIONS</span><h1 class="section-title">Power the Digital World.</h1><p style="color:var(--text-muted); font-size:1.1rem; line-height:1.8; max-width:700px;">Data centre physical infrastructure, cooling, power redundancy, rack management and enterprise uptime operations.</p><button class="nav-btn-champagne" style="margin-top:2rem;" onclick="alert('Application submitted for DCOM Course!')">Apply / Enquire Now</button></section>`}renderStudentLifeView(){return`
      <section class="section-wrapper" style="padding-top: 12rem;">
        <span class="section-label">CAMPUS LIFE & ACHIEVEMENTS</span>
        <h1 class="section-title">Student Life at DBSM</h1>
        <p style="font-size: 1.1rem; color: var(--text-muted); max-width: 600px; margin-bottom: 4rem;">
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2.5rem;">
          <div style="background:#FFF; border:1px solid var(--glass-border); padding:2rem;">
        ...
        <div class="faculty-sticky-viewport">
          ...
          <div class="faculty-track-viewport">
            <div class="faculty-track" id="faculty-track">
              ${[{num:`01`,name:`Fr. Eugene Florence`,role:`Director`,status:`Resident Director`,badge:`Leadership`,desc:`Visionary institutional director guiding strategic expansion, academic excellence, and holistic youth empowerment at Don Bosco Skill Mission.`,img:`/fr_eugene.png`,contact:`director@dbsm.dbtech.in`},{num:`02`,name:`Bro. Barnabas Khriam`,role:`Assistant Director & Center Head`,status:`Resident Leadership`,badge:`Center Head`,desc:`Overseeing daily operational excellence, campus administration, and technical domain integration across all centers of excellence.`,img:`/bro_barnabas.jpg`,contact:`barnabas@dbsm.dbtech.in`},{num:`03`,name:`Fr. Britto Francis`,role:`Assistant Director & Center Head`,status:`Resident Leadership`,badge:`Center Head`,desc:`Spearheading student welfare, placement partnerships, industry alliances, and residential community development.`,img:`/fr_britto.png`,contact:`britto@dbsm.dbtech.in`},{num:`04`,name:`Akarsh Raj A P`,role:`Trainer – Cloud Computing`,status:`Master Trainer`,badge:`AWS Specialist`,desc:`Lead AWS re/Start Cloud Architecture instructor specializing in Linux systems, Python automation, and DevOps deployment.`,img:`https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=600`,contact:`akarsh@dbsm.dbtech.in`},{num:`05`,name:`Steffi Pais`,role:`Front Desk Officer & Admin In-charge`,status:`Administration`,badge:`Operations`,desc:`Managing executive front desk relations, student admissions intake, corporate visitor protocols, and administrative workflows.`,img:`https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=600`,contact:`steffi@dbsm.dbtech.in`},{num:`06`,name:`Pritto Thomas`,role:`Assistant Manager – State Operations`,status:`State Operations`,badge:`Management`,desc:`Coordinating state-wide skill program logistics, government partnership compliance, and institutional outreach initiatives.`,img:`https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=600`,contact:`pritto@dbsm.dbtech.in`},{num:`07`,name:`Jhonson Botistotopno`,role:`Campus Security Lead`,status:`Campus Safety`,badge:`Security`,desc:`Ensuring 24/7 campus security, resident student housing safety, access control protocols, and overall facility protection.`,img:`https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=600`,contact:`security@dbsm.dbtech.in`}].map((e,t)=>`
