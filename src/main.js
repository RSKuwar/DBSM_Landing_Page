  ...
  renderFacultyView() {
    const facultyMembers = [
      ...
      },
      {
        ...
        desc: 'Lead AWS re/Start Cloud Architecture instructor specializing in Linux systems, Python automation, and DevOps deployment.',
        img: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=600',
        contact: 'akarsh@dbsm.dbtech.in'
      },
      {
        num: '05',
        name: 'Steffi Pais',
        role: 'Front Desk Officer & Admin In-charge',
        status: 'Administration',
        badge: 'Operations',
        desc: 'Managing executive front desk relations, student admissions intake, corporate visitor protocols, and administrative workflows.',
        img: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=600',
        contact: 'steffi@dbsm.dbtech.in'
      },
      {
        num: '06',
        name: 'Pritto Thomas',
        role: 'Assistant Manager – State Operations',
        status: 'State Operations',
        badge: 'Management',
        desc: 'Coordinating state-wide skill program logistics, government partnership compliance, and institutional outreach initiatives.',
        img: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=600',
        contact: 'pritto@dbsm.dbtech.in'
      },
      {
        num: '07',
        name: 'Jhonson Botistotopno',
        role: 'Campus Security Lead',
        status: 'Campus Safety',
        badge: 'Security',
        desc: 'Ensuring 24/7 campus security, resident student housing safety, access control protocols, and overall facility protection.',
        img: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=600',
        contact: 'security@dbsm.dbtech.in'
      }
    ];
